...
4. Follow this execution flow:
    ...
    4. Fill User Scenarios & Testing section
       User Story 1 MUST represent the MVP acceptance path
       If no clear user flow: ERROR "Cannot determine user scenarios"
    5. Generate Functional Requirements
       Each requirement must be testable
       Include experience/accessibility requirements and data/integration
    ...
    6. Define Assumptions & Scope Guardrails
       Record explicit assumptions, out-of-scope items, and only the
       dependencies required for the MVP
